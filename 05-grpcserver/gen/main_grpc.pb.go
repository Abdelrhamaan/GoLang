...
func (c *greeterClient) Greet(ctx context.Context, in *GreeterRequest, opts ...grpc.CallOption) (*GreeterResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedGreeterServer) Greet(context.Context, *GreeterRequest) (*GreeterResponse, error) {
...
func _Greeter_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Greet(ctx, req.(*GreeterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
