...
const file_greeter_proto_rawDesc = "" +
	...
	"\amessage\x18\x01 \x01(\tR\amessageB\x14Z\x12/gen; calculatorpbb\x06proto3"
...
var file_greeter_proto_goTypes = []any{
	(*GreeterRequest)(nil),  // 0: calculator.GreeterRequest
	(*GreeterResponse)(nil), // 1: calculator.GreeterResponse
}
