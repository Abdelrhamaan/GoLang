...
const file_main_proto_rawDesc = "" +
	...
	"\tCalculate\x126\n" +
	"\x03Add\x12\x16.calculator.AddRequest\x1a\x17.calculator.AddResponse2K\n" +
	"\aGreeter\x12@\n" +
	"\x05Greet\x12\x1a.calculator.GreeterRequest\x1a\x1b.calculator.GreeterResponseB\x14Z\x12/gen; calculatorpbb\x06proto3"
...
var file_main_proto_goTypes = []any{
	...
	(*GreeterRequest)(nil),  // 2: calculator.GreeterRequest
	(*GreeterResponse)(nil), // 3: calculator.GreeterResponse
}
var file_main_proto_depIdxs = []int32{
	0, // 0: calculator.Calculate.Add:input_type -> calculator.AddRequest
	2, // 1: calculator.Greeter.Greet:input_type -> calculator.GreeterRequest
	1, // 2: calculator.Calculate.Add:output_type -> calculator.AddResponse
	3, // 3: calculator.Greeter.Greet:output_type -> calculator.GreeterResponse
