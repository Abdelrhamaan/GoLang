...
type Address struct {
	...
	Ctiy          string                 `protobuf:"bytes,2,opt,name=ctiy,proto3" json:"ctiy,omitempty"`
...
const file_order_proto_rawDesc = "" +
	...
	"\x04ctiy\x18\x02 \x01(\tR\x04ctiy\x12\x14\n" +
	"\x05state\x18\x03 \x01(\tR\x05stateB\x0fZ\r./gen; mainpbb\x06proto3"
