...
type HelloResponse struct {
	...
	Data          []string               `protobuf:"bytes,2,rep,name=data,proto3" json:"data,omitempty"` // ["ahmed", "ali", "yassen"]
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_main_proto_rawDesc = "" +
	...
	"\x03age\x18\x02 \x01(\x05R\x03age\"F\n" +
	"\rHelloResponse\x12!\n" +
	"\fconf_message\x18\x01 \x01(\tR\vconfMessage\x12\x12\n" +
	...
	"\x06Orders\x12\n" +
	".user.User\x1a\v.main.OrderB\x0fZ\r./gen; mainpbb\x06proto3"
